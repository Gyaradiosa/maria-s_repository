...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/17 23:06:40 by maduarte          #+#    #+#             */
/*   Updated: 2024/03/17 23:06:47 by maduarte         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char *argv[]) {
    ...
    if (digits == 1) {
        ...
        if (tens_digit == 1) {
            ...
            char tens_str[3];
            char units_str[3];
            snprintf(tens_str, sizeof(tens_str), "%d0", tens_digit);
            snprintf(units_str, sizeof(units_str), "%d", units_digit);
